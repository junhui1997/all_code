...
from exp.exp_sep import Exp_sep
import random
import numpy as np
...
parser = argparse.ArgumentParser(description='neural')

# basic config
parser.add_argument('--task_name', type=str, required=True, default='encoder',
                    help='task name, options:[long_term_forecast, short_term_forecast, imputation, classification, anomaly_detection, decoder]')
