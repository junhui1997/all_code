...
imagenet_data = torchvision.datasets.FashionMNIST("./dataset/fashion/raw/", train=True, download=False, transform=transforms.ToTensor())
...
# 采样:sample 64 images
# 采样时候的batch_size和训练时候的并不是一个
samples = DDPM(mode="generate", image_size=image_size, batch_size=32, channels=channels)
